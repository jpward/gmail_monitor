...
DEFAULT_CLIENT_SECRET = None # Read from a file or environmental variable in a real app

# The gmail modify scope
SCOPE = u'https://www.googleapis.com/auth/gmail.modify'
...
def main(client_id, client_secret, scopes):
  ...
  print ('Log into the Google Account'
